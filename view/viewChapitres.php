    ...
    <body>
		...
		<div id="cadre_chapitres">
			<div class="extraitChap">
				<span><?php getTitle();?> </span><br><a class="liens_h1" href="chapter?id=1"> Lire le chapitre</a>
				<p><?php
				  getExt();
			...
			<hr />
			<div class="extraitChap">
				<span><?php getTitle();?></span><br><a class="liens_h1" href="chapter?id=2"> Lire le chapitre</a>
				<p><?php
					getExt();
						?>
				</p>
